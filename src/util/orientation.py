...
# This is a helper class for calculating directions relative to your car. 
# You can extend it or delete if you want.
class Orientation:
    """
...
# For example, set center to your car's location and ori to your car's orientation,
